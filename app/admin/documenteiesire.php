...
?>
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-10 col-md-10 col-lg-10" style="padding-top: 15px;">
            <p><a href="/">Acasa</a> > Documente Iesire</p>
            ...
            $docs = $dbh -> query("SELECT * FROM facturi_chitante WHERE incasat = '0'");
            $doc = 1;
            foreach($docs as $row)
            {
                ?>
                <tr>
                    ...
                    <td><span style="color: #dc3545;"><?php echo number_format($row['platit'],2,",","."); ?> lei</span></td>
                    <td><a href="docs/<?php echo $row['chitanta_factura']; ?>" target="_blank"><button type="button" class="btn btn-primary"><i class="fas fa-eye"></i> Vezi documentul</button></a></td>
                </tr>
                <?php
                $doc++;
            }
