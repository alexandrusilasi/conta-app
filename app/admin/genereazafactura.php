...
$html = file_get_contents("https://app.medicalpubit.ro/admin/pdf.php?id_comanda=".$id_comanda."&id_partener=".$id_partener);
...
try {
  ...
  elseif($count == 0)
  {
      ...
      $dbh -> exec("INSERT INTO facturi_chitante(id_comanda , partener , chitanta_factura , data_ora , incasat , platit , tip) VALUES('$id_comanda' , '$id_partener' , '$nume_factura' , '$data_ora' , '$total_final' , '0' , 'factura')");
  }
