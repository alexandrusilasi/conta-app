...
?>
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-10 col-md-10 col-lg-10" style="padding-top: 15px;">
            <p><a href="/">Acasa</a> > Lista Comenzi</p>
            <div style="display: flex; flex-wrap: wrap; align-items: flex-end;">
                ...
                <div style="width: 30%;" class="searchwrapper">
                    ...
                    <input type="text" id="cautare" placeholder="Cautare dupa numar de comanda..." />
                </div>
            ...
            <div class="comenzi"></div>
        </div>
        <div class="col-xs-12 col-sm-1 col-md-1 col-lg-1"></div>
    </div>
    <script>
        $(document).ready(function(){
            $("div.comenzi").load("afisarecomenzi.php");
